/**
 * Vue 3 UserList Component (With Dynamic Role Selector)
 */
const UserList = {
  name: 'UserList',
  props: {
  ...
  methods: {
    ...
    onAvatarError(e, name) {
      e.target.src = 'https://ui-avatars.com/api/?name=' + encodeURIComponent(name || 'User') + '&background=4f46e5&color=fff';
    },
    async onRoleChange(user) {
      try {
        ...
        console.error('Error enviando actualización de rol:', err);
